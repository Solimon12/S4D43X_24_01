...
define root view entity ZI_20_Flight
  as select from sflight
  composition [0..*] of ZI_20_Booking     as _Bookings
  association [1..1] to ZI_20_CarrierText as _CarrierText on $projection.CarrierID = _CarrierText.Carrid
{
